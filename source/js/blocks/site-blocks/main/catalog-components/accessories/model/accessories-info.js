...
const accessoriesInfo = [
  {
    ...
    price: '6 500',
    imgPath: 'assets/img/watch_strap_1.png',
    extraImgs: ['assets/img/watch_strap_1.png', 'assets/img/watch_strap_1.png', 'assets/img/watch_strap_1.png'],
  ...
  },
  {
    ...
    brandName: 'Nato',
    price: '3 200',
    imgPath: 'assets/img/watch_strap_2.png',
    extraImgs: ['assets/img/watch_strap_2.png', 'assets/img/watch_strap_2.png'],
  ...
  },
  {
    ...
    extraImgs: ['assets/img/watch_strap_3.png', 'assets/img/watch_strap_3.png', 'assets/img/watch_strap_3.png', 'assets/img/watch_strap_3.png'],
