...
import { Section, Headline, List, Li, CatalogHeadline, CatalogInformationContainer, LinkToSection } from './s-catalog';
      ...
      {data.map((section) => (
        <Li key={section.catalogName} backgroundImagePaths={section.backgroundImagePaths}>
          ...
          <CatalogInformationContainer>
            ...
            <LinkToSection href={section.linkToSection} title={section.title}>Перейти</LinkToSection>
          </CatalogInformationContainer>
        </Li>
      ))}
    </List>
