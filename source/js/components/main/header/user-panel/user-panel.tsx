...
import { Container, PanelList, SearchButton } from './s-user-panel';
...
const UserPanel: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <PanelList>
        <li>
          <SearchButton id="search-button" type="button" onClick={searchInputHandler} title="Кнопка для вызова поля поиска">
        ...
        <li>
          <a href="/favorite" title="В избранное">
