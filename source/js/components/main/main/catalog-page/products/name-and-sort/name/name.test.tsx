...
describe('Testing <Name /> component', () => {
  test('Should write right section catalog name', () => {
    ...
    render(<MemoryRouter initialEntries={[{ pathname: `/catalog/${filteredRouteListByType[randomSectionNumber].route}` }]}><Name /></MemoryRouter>);
  ...
  test('Should return reserve string for unknown section catalog name', () => {
    render(<MemoryRouter initialEntries={[{ pathname: '/catalog/auto' }]}><Name /></MemoryRouter>);
