...
const ArrowButton: FC<IArrowButton> = ({ className, title, side, disabled, onClick }) => (
  <Button className={className} type="button" title={title} side={side} disabled={disabled} onClick={onClick}>
